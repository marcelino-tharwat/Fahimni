...
export const TEACHER1_CHAPTERS: SeedChapter[] = [
  ...
  chapter(
    "f4500100",
    STAGE_G1,
    "الرياضيات — الدوال الخطية",
    "دراسة الدالة الخطية وميلها وتمثيلها البياني.",
    1,
    [
      {
  ...
  chapter(
    "f4500101",
    STAGE_G1,
    "الرياضيات — المعادلات التربيعية",
    "المعادلات من الدرجة الثانية وطرق حلها.",
    2,
    [
      {
        title: "مفهوم المعادلة التربيعية",
        description: "الصورة العامة للمعادلة التربيعية ومميزها.",
      },
      {
        title: "التحليل إلى عوامل",
        description: "حل المعادلة التربيعية بالتحليل إلى عوامل.",
      },
      {
        title: "القانون العام",
        description: "استخدام القانون العام لإيجاد جذور المعادلة.",
      },
    ],
    "29.99",
  ),
  chapter(
    ...
    "وصف الحركة في بعد واحد.",
    3,
    [
      {
        title: "المسافة والإزاحة",
        description: "الفرق بين الكمية القياسية والكمية المتجهة.",
      },
      {
        title: "السرعة والسرعة المتجهة",
        description: "حساب السرعة المتوسطة والسرعة المتجهة.",
      },
      {
        title: "العجلة",
        description: "مفهوم العجلة ومعادلات الحركة بعجلة منتظمة.",
      },
    ],
    "39.99",
  ),
  chapter(
    ...
    [
      ...
      },
      {
        ...
        description: "تعريف العدد الذري والكتلي والنظائر.",
      },
      {
        title: "التوزيع الإلكتروني",
        description: "توزيع الإلكترونات على المستويات.",
      },
    ],
    "19.99",
  ),
  ...
  chapter(
    ...
    [
      { title: "النسب المثلثية", description: "الجيب وجيب التمام والظل." },
      {
        ...
        description: "تعريف النسب على دائرة الوحدة.",
      },
      {
        title: "المتطابقات المثلثية",
        description: "المتطابقات الأساسية وتطبيقاتها.",
      },
    ],
    "49.99",
  ),
    ...
    [
      {
        ...
        description: "تكوّن الرابطة الأيونية بانتقال الإلكترونات.",
      },
      {
        title: "الرابطة التساهمية",
        description: "المشاركة الإلكترونية في الرابطة التساهمية.",
      },
  ...
  chapter(
    "f4500113",
    STAGE_G2,
    "الأحياء — النقل في الكائنات الحية",
    "آليات النقل داخل الكائن الحي.",
    4,
    [
      {
        title: "النقل عبر الغشاء",
        description: "النقل النشط والسلبي عبر الغشاء الخلوي.",
      },
  ...
  chapter(
    ...
    [
      ...
      { title: "المشتقة الأولى", description: "قواعد الاشتقاق الأساسية." },
      {
        ...
        description: "القيم العظمى والصغرى والمماس.",
      },
    ],
    "59.99",
  ),
  chapter(
    "f4500121",
    STAGE_G3,
    "الكيمياء — الاتزان الكيميائي",
    "الاتزان وثابته وعوامل تأثيره.",
    2,
    [
      {
        title: "مفهوم الاتزان",
        description: "الاتزان الديناميكي في التفاعلات.",
      },
      { title: "ثابت الاتزان", description: "حساب ثابت الاتزان وتفسيره." },
      {
        title: "مبدأ لو شاتيليه",
        description: "تأثير العوامل على موضع الاتزان.",
      },
    ],
    "24.99",
  ),
  chapter(
    "f4500122",
    STAGE_G3,
    "الفيزياء — التيار الكهربي",
    "التيار والمقاومة والدوائر.",
    3,
    [
      {
        title: "التيار والفرق الجهدي",
        description: "تعريف التيار وفرق الجهد.",
      },
      {
        title: "قانون أوم",
      ...
      },
      {
        ...
        description: "التوصيل على التوالي والتوازي.",
      },
    ],
    null,
  ),
  chapter(
    ...
    STAGE_G3,
    "الأحياء — الوراثة",
    "قوانين الوراثة والمادة الوراثية.",
    4,
    [
