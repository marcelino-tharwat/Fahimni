...
export function buildQuizGenerationPrompt(
  ...
  return [
    ...
    '13. أضف لكل سؤال الحقل "difficulty" بقيمة "easy" أو "medium" أو "hard" مطابقة لمستوى صعوبته الفعلي وفق التوزيع المطلوب أعلاه.',
    "14. أعد الإخراج على هيئة JSON صالح فقط، دون أي شرح أو نص إضافي خارج كائن JSON.",
    "",
